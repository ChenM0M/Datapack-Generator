...
class Ui_MainWindow(QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.recipes_TypeSelected.setGeometry(QtCore.QRect(190, 20, 300, 171))
    ...
    def recipes_crafting_gen(self):
        ...
        if self.recipes_TypeSelected.currentIndex() == 0 and self.recipes_fileNameInput!="":
        ...
        elif self.recipes_TypeSelected.currentIndex() == 1 and len(self.shapless_ItemList)>=1:
            result={
                "type":"minecraft:crafting_shapless",
                "ingredients":[],
                "result":{"item":self.crafting_shapless_OutputID.text(),
                          "count":self.crafting_shapless_OutputCountInput.value()}
            }
            for i in self.shapless_ItemList:
    ...
    def recipes_crafting_shapless_addItem(self):
        if len(self.shapless_ItemList)<=9 and self.recipes_reflashListFunc.text()!="":
            ...
            QMessageBox.warning(None,"无序合成列表最大值:9")
